...
export const CLASSES = {
  ...
  mage: {
    ...
    id: 'mage', name: '마법사', weaponTypes: ['staff', 'dagger'], armorRestriction: ['cloth'], statScaling: { atk: 'int' },
  ...
  priest: {
    ...
    id: 'priest', name: '성직자', weaponTypes: ['staff', 'dagger'], armorRestriction: ['cloth'], statScaling: { atk: 'wis' },
    skills: [

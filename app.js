...
const NOTICE_PREV = {
  version: '2026-07-18',
  ko: "📢 업데이트 안내 (2026-07-18)\n\n① 퀴즈 문제 은행에 신규 10문항 추가 (AMM 유동성, QuizPi 게임 모드, 지갑 리스크 스코어, SEC 규제 등)\n② 전체 18개 언어 번역 완료\n③ 일부 기존 문항의 번역이 뒤바뀌어 표시되던 오류 수정",
  en: "📢 Update Notice (2026-07-18)\n\n① Added 10 new quiz questions (AMM liquidity, QuizPi game modes, wallet risk score, SEC regulation, and more)\n② All questions now fully translated into 18 languages\n③ Fixed a bug where some existing questions showed mismatched translations",
  zh: "📢 更新通知 (2026-07-18)\n\n① 新增10道测验题目（AMM流动性、QuizPi游戏模式、钱包风险评分、SEC监管等）\n② 全部题目已完成18种语言翻译\n③ 修复了部分现有题目翻译显示错乱的问题",
  id: "📢 Pemberitahuan Pembaruan (2026-07-18)\n\n① Menambahkan 10 soal kuis baru (likuiditas AMM, mode permainan QuizPi, skor risiko dompet, regulasi SEC, dll.)\n② Semua soal kini diterjemahkan penuh ke 18 bahasa\n③ Memperbaiki bug di mana beberapa soal lama menampilkan terjemahan yang tertukar",
  ja: "📢 アップデートのお知らせ (2026-07-18)\n\n① クイズ問題バンクに新規10問を追加（AMM流動性、QuizPiゲームモード、ウォレットリスクスコア、SEC規制など）\n② 全問題を18言語に完全翻訳\n③ 一部の既存問題で翻訳が入れ替わって表示される不具合を修正",
  es: "📢 Aviso de actualización (2026-07-18)\n\n① Se añadieron 10 preguntas nuevas al banco de preguntas (liquidez AMM, modos de juego de QuizPi, puntuación de riesgo de cartera, regulación de la SEC, etc.)\n② Todas las preguntas ahora están traducidas a los 18 idiomas\n③ Se corrigió un error que mostraba traducciones intercambiadas en algunas preguntas existentes",
  fr: "📢 Avis de mise à jour (2026-07-18)\n\n① Ajout de 10 nouvelles questions au banc de quiz (liquidité AMM, modes de jeu QuizPi, score de risque du portefeuille, réglementation SEC, etc.)\n② Toutes les questions sont désormais entièrement traduites en 18 langues\n③ Correction d'un bug où certaines questions existantes affichaient des traductions inversées",
  vi: "📢 Thông báo cập nhật (2026-07-18)\n\n① Đã thêm 10 câu hỏi mới vào ngân hàng câu hỏi (thanh khoản AMM, chế độ chơi QuizPi, điểm rủi ro ví, quy định SEC, v.v.)\n② Tất cả câu hỏi hiện đã được dịch đầy đủ sang 18 ngôn ngữ\n③ Đã sửa lỗi một số câu hỏi cũ hiển thị bản dịch bị lẫn lộn",
  pt: "📢 Aviso de atualização (2026-07-18)\n\n① Adicionadas 10 novas perguntas ao banco de perguntas (liquidez AMM, modos de jogo do QuizPi, pontuação de risco da carteira, regulamentação da SEC, etc.)\n② Todas as perguntas agora estão totalmente traduzidas em 18 idiomas\n③ Corrigido um bug em que algumas perguntas existentes exibiam traduções trocadas",
  ms: "📢 Notis Kemas Kini (2026-07-18)\n\n① Menambah 10 soalan kuiz baharu (kecairan AMM, mod permainan QuizPi, skor risiko dompet, peraturan SEC, dan lain-lain)\n② Semua soalan kini diterjemah sepenuhnya ke 18 bahasa\n③ Membetulkan pepijat di mana sesetengah soalan sedia ada memaparkan terjemahan yang tertukar",
  tl: "📢 Abiso sa Update (2026-07-18)\n\n① Nagdagdag ng 10 bagong tanong sa quiz bank (AMM liquidity, QuizPi game modes, wallet risk score, regulasyon ng SEC, atbp.)\n② Buong isinalin na ngayon ang lahat ng tanong sa 18 wika\n③ Naayos ang bug kung saan may mga lumang tanong na nagpapakita ng maling salin",
  hi: "📢 अपडेट सूचना (2026-07-18)\n\n① क्विज़ प्रश्न बैंक में 10 नए प्रश्न जोड़े गए (AMM लिक्विडिटी, क्विज़पाई गेम मोड, वॉलेट रिस्क स्कोर, SEC नियमन आदि)\n② सभी प्रश्न अब पूरी तरह 18 भाषाओं में अनुवादित हैं\n③ कुछ पुराने प्रश्नों में गलत अनुवाद दिखने की समस्या को ठीक किया गया",
  ar: "📢 إشعار التحديث (2026-07-18)\n\n① تمت إضافة 10 أسئلة جديدة إلى بنك الأسئلة (سيولة AMM، أوضاع لعبة QuizPi، درجة خطورة المحفظة، لوائح SEC، وغيرها)\n② أصبحت جميع الأسئلة مترجمة بالكامل إلى 18 لغة\n③ تم إصلاح خطأ كانت بعض الأسئلة الموجودة تعرض فيه ترجمات متبادلة بالخطأ",
  ru: "📢 Уведомление об обновлении (2026-07-18)\n\n① В банк вопросов добавлено 10 новых вопросов (ликвидность AMM, игровые режимы QuizPi, показатель риска кошелька, регулирование SEC и др.)\n② Все вопросы теперь полностью переведены на 18 языков\n③ Исправлена ошибка, из-за которой некоторые существующие вопросы показывали перепутанные переводы",
  bn: "📢 আপডেট বিজ্ঞপ্তি (2026-07-18)\n\n① কুইজ প্রশ্ন ব্যাংকে ১০টি নতুন প্রশ্ন যোগ করা হয়েছে (AMM লিকুইডিটি, কুইজপাই গেম মোড, ওয়ালেট রিস্ক স্কোর, SEC নিয়ন্ত্রণ ইত্যাদি)\n② সব প্রশ্ন এখন সম্পূর্ণভাবে ১৮টি ভাষায় অনূদিত\n③ কিছু পুরনো প্রশ্নে ভুল অনুবাদ দেখানোর সমস্যা সমাধান করা হয়েছে",
  sw: "📢 Taarifa ya Sasisho (2026-07-18)\n\n① Imeongeza maswali 10 mapya kwenye benki ya maswali (ukwasi wa AMM, njia za mchezo za QuizPi, alama ya hatari ya pochi, kanuni za SEC, na mengineyo)\n② Maswali yote sasa yametafsiriwa kikamilifu katika lugha 18\n③ Imerekebisha hitilafu ambapo baadhi ya maswali ya zamani yalionyesha tafsiri zilizochanganyika",
  th: "📢 แจ้งอัปเดต (2026-07-18)\n\n① เพิ่มคำถามใหม่ 10 ข้อในคลังคำถาม (สภาพคล่อง AMM, โหมดเกม QuizPi, คะแนนความเสี่ยงกระเป๋าเงิน, กฎระเบียบ SEC และอื่นๆ)\n② คำถามทั้งหมดแปลครบถ้วนใน 18 ภาษาแล้ว\n③ แก้ไขข้อบกพร่องที่คำถามเก่าบางข้อแสดงคำแปลสลับกัน",
  tr: "📢 Güncelleme Bildirimi (2026-07-18)\n\n① Soru bankasına 10 yeni soru eklendi (AMM likiditesi, QuizPi oyun modları, cüzdan risk skoru, SEC düzenlemeleri vb.)\n② Tüm sorular artık 18 dile tam olarak çevrildi\n③ Bazı mevcut soruların yanlış çevirilerle gösterildiği hata giderildi",
};

...
const LOOT_POOL = [
  ...
  { itemId: 'armor_uncommon', weight: 6 },
  { itemId: 'armor_light_uncommon', weight: 5 },
  { itemId: 'armor_cloth_uncommon', weight: 4 },
  { itemId: 'ring_uncommon', weight: 12 },
  { itemId: 'necklace_uncommon', weight: 12 },
  { itemId: 'weapon_rare', weight: 5 },
  { itemId: 'armor_rare', weight: 2 },
  { itemId: 'armor_light_rare', weight: 1.5 },
  { itemId: 'armor_cloth_rare', weight: 1.5 },
  ...
  { itemId: 'ring_wisdom', weight: 1.5 },
  { itemId: 'necklace_wisdom', weight: 1.5 },
  { itemId: 'weapon_legendary', weight: 1 },
  { itemId: 'armor_legendary', weight: 0.4 },
  { itemId: 'armor_light_legendary', weight: 0.3 },
  { itemId: 'armor_cloth_legendary', weight: 0.3 },

...
const TT = {
  ko: {
    ...
    'tax.disposal.date': '일시', 'tax.disposal.qty': '수량', 'tax.disposal.proceeds': '처분가액', 'tax.disposal.scroll_hint': '◀ ▶ 좌우로 밀어서 더 보기',
  ...
  en: {
    ...
    'tax.disposal.date': 'Date', 'tax.disposal.qty': 'Qty', 'tax.disposal.proceeds': 'Proceeds', 'tax.disposal.scroll_hint': '◀ ▶ Swipe to see more',
  ...
  zh: {
    ...
    "tax.disposal.date": "日期", "tax.disposal.qty": "数量", "tax.disposal.proceeds": "处置金额", "tax.disposal.scroll_hint": "◀ ▶ 左右滑动查看更多",
  ...
  id: {
    ...
    "tax.disposal.date": "Tanggal", "tax.disposal.qty": "Jumlah", "tax.disposal.proceeds": "Hasil Penjualan", "tax.disposal.scroll_hint": "◀ ▶ Geser untuk melihat lebih banyak",
  ...
  ja: {
    ...
    "tax.disposal.date": "日時", "tax.disposal.qty": "数量", "tax.disposal.proceeds": "処分価額", "tax.disposal.scroll_hint": "◀ ▶ 左右にスワイプしてさらに表示",
  ...
  es: {
    ...
    "tax.disposal.date": "Fecha", "tax.disposal.qty": "Cantidad", "tax.disposal.proceeds": "Ingresos", "tax.disposal.scroll_hint": "◀ ▶ Desliza para ver más",
  ...
  fr: {
    ...
    "tax.disposal.date": "Date", "tax.disposal.qty": "Qté", "tax.disposal.proceeds": "Produit de Cession", "tax.disposal.scroll_hint": "◀ ▶ Glissez pour en voir plus",
  ...
  vi: {
    ...
    "tax.disposal.date": "Ngày", "tax.disposal.qty": "SL", "tax.disposal.proceeds": "Số Tiền Thu Được", "tax.disposal.scroll_hint": "◀ ▶ Vuốt sang hai bên để xem thêm",
  ...
  pt: {
    ...
    "tax.disposal.date": "Data", "tax.disposal.qty": "Qtd", "tax.disposal.proceeds": "Valor da Venda", "tax.disposal.scroll_hint": "◀ ▶ Deslize para ver mais",
  ...
  ms: {
    ...
    "tax.disposal.date": "Tarikh", "tax.disposal.qty": "Kuantiti", "tax.disposal.proceeds": "Hasil Pelupusan", "tax.disposal.scroll_hint": "◀ ▶ Leret untuk lihat lagi",
  ...
  tl: {
    ...
    "tax.disposal.date": "Petsa", "tax.disposal.qty": "Dami", "tax.disposal.proceeds": "Kinita", "tax.disposal.scroll_hint": "◀ ▶ I-swipe para makita pa",
  ...
  hi: {
    ...
    "tax.disposal.date": "तारीख", "tax.disposal.qty": "मात्रा", "tax.disposal.proceeds": "बिक्री राशि", "tax.disposal.scroll_hint": "◀ ▶ और देखने के लिए स्वाइप करें",
  ...
  ar: {
    ...
    "tax.disposal.date": "التاريخ", "tax.disposal.qty": "الكمية", "tax.disposal.proceeds": "عائدات البيع", "tax.disposal.scroll_hint": "◀ ▶ اسحب لرؤية المزيد",
  ...
  ru: {
    ...
    "tax.disposal.date": "Дата", "tax.disposal.qty": "Кол-во", "tax.disposal.proceeds": "Выручка", "tax.disposal.scroll_hint": "◀ ▶ Проведите, чтобы увидеть больше",
  ...
  bn: {
    ...
    "tax.disposal.date": "তারিখ", "tax.disposal.qty": "পরিমাণ", "tax.disposal.proceeds": "বিক্রয় মূল্য", "tax.disposal.scroll_hint": "◀ ▶ আরও দেখতে সোয়াইপ করুন",
  ...
  sw: {
    ...
    "tax.disposal.date": "Tarehe", "tax.disposal.qty": "Kiasi", "tax.disposal.proceeds": "Mapato ya Mauzo", "tax.disposal.scroll_hint": "◀ ▶ Telezesha kuona zaidi",
  ...
  th: {
    ...
    "tax.disposal.date": "วันที่", "tax.disposal.qty": "จำนวน", "tax.disposal.proceeds": "มูลค่าที่ได้รับ", "tax.disposal.scroll_hint": "◀ ▶ ปัดเพื่อดูเพิ่มเติม",
  ...
  tr: {
    ...
    "tax.disposal.date": "Tarih", "tax.disposal.qty": "Miktar", "tax.disposal.proceeds": "Satış Geliri", "tax.disposal.scroll_hint": "◀ ▶ Daha fazlası için kaydırın",
  ...
  async function renderTaxTab() {
    ...
    const renderForAsset = async (asset) => {
      ...
      const disposalTable = (result) => {
        ...
        const hasKrw = result.disposals.some(d => d.gainKrw != null);
        return `<p class="trk-scroll-hint">${tt('tax.disposal.scroll_hint')}</p>
        <div class="trk-scroll-x">
